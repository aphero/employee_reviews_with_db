...
EmployeeReviewMigration.migrate(:up)
  ...
  # test = Employee.create( name: "Cyan", email: "cyan@ff6.com", phone: "515-888-4821", salary: 85000)
  # Employee.create(name: "Terra", email: "terra@ff6.com", phone: "123-456-7890", salary: 85000)
  # Employee.create(name: "Terra", email: "terra2@ff6.com", phone: "123-456-7890", salary: 85000)
  # puts test.email
  # puts Employee.select('email').where(['name = ?', "Terra"]).first.email

class ReviewsTest < Minitest::Test

  def test_create_new_department_01
    assert Department.create(name: "R&D")
  ...
  def test_create_new_employee_02
    assert Employee.create( name: "Cyan", email: "cyan@figaro.com", phone: "515-888-4821", salary: 85000)
    # assert_raises(ArgumentError) do
  ...
  def test_add_employee_to_department_03
    e = Employee.create(name: "Terra", email: "terra@figaro.com", phone: "123-456-7890", salary: 85000)
    d = Department.create(name: "Customer Service")
    e.department_id = d.id
    assert_equal d.id, e.department_id
  end

  def test_get_employee_name_04
    employee = Employee.create( name: "Locke", email: "locke@figaro.com", phone: "234-567-8901", salary: 85000)
    assert_equal "Locke", employee.name
  end

  def test_get_employee_salary_05
    employee = Employee.create( name: "Edgar", email: "edgar@figaro.com", phone: "345-678-9012", salary: 85000)
  ...
  def test_get_department_salary_06
    ...
    employee.save
    employee2.save
    assert_equal dept.total_salary, 230000
  end

  def test_employees_can_be_reviewed_07
    employee = Employee.create(name: "Shadow", email: "shadow@figaro.com", phone: "515-888-4821", salary: 80000)
    employee.review = "This employee started off great. Not as impressed with her recent performance."
    assert_equal "This employee started off great. Not as impressed with her recent performance.", employee.review
  end
